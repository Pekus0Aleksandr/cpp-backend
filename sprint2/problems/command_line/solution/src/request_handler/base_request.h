...
namespace http_handler {
    ...
    public:
        ...
        static StringResponse MakeStringResponse(http::status status, std::string_view requestTarget, unsigned http_version,
                                                 bool keep_alive, std::string_view content_type = ContentType::APP_JSON,bool no_cache = false);
    protected:
        ...
        StringResponse MakeBadResponse(http::status status, unsigned http_version, bool keep_alive, std::string_view content_type = ContentType::APP_JSON) const;
        StringResponse MakeInvalidMethod(std::string_view allow_methods, unsigned http_version, bool keep_alive) const;
